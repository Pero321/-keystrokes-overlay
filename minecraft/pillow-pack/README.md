...
Усі текстури згенеровані кодом — жодних бінарників, які не можна відтворити.
Скрипт пише PNG вручну через `zlib` зі стандартної бібліотеки, тож
залежностей (Pillow тощо) не потрібно.
...
Той самий MIT, що й у решті репозиторію — див. [LICENSE](../../LICENSE).
